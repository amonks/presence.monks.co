...
var G__15392 = db;
var G__15393 = cljs.core.vec(cljs.core.rest(v));
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(G__15392,G__15393) : handler.call(null,G__15392,G__15393));
});
});
/**
...
while (G__15394__i < G__15394__a.length) {G__15394__a[G__15394__i] = arguments[G__15394__i + 0]; ++G__15394__i;}
  args = new cljs.core.IndexedSeq(G__15394__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__15395){
...
var G__15410 = (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(db,v) : handler.call(null,db,v));
var G__15411 = v;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__15410,G__15411) : f.call(null,G__15410,G__15411));
});
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__15412_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,new_ins){
return (function (p1__15413_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,p1__15413_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__15414__i = 0, G__15414__a = new Array(arguments.length -  2);
while (G__15414__i < G__15414__a.length) {G__15414__a[G__15414__i] = arguments[G__15414__i + 2]; ++G__15414__i;}
  in_paths = new cljs.core.IndexedSeq(G__15414__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__15415){
var f = cljs.core.first(arglist__15415);
arglist__15415 = cljs.core.next(arglist__15415);
var out_path = cljs.core.first(arglist__15415);
var in_paths = cljs.core.rest(arglist__15415);
