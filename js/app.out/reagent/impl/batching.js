...
var or__6459__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__6459__auto__)){
return or__6459__auto__;
} else {
var or__6459__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__6459__auto____$1)){
return or__6459__auto____$1;
} else {
var or__6459__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__6459__auto____$2)){
return or__6459__auto____$2;
} else {
var or__6459__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__6459__auto____$3)){
return or__6459__auto____$3;
} else {
...
var n__7362__auto__ = a.length;
var i = (0);
while(true){
if((i < n__7362__auto__)){
var c_14675 = (a[i]);
if((c_14675["cljsIsDirty"]) === true){
(c_14675["forceUpdate"])();
} else {
}
...
var G__14677 = ((function (this$){
return (function (){
return this$.run_queues();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__14677) : reagent.impl.batching.next_tick.call(null,G__14677));
}
});
...
var temp__4429__auto___14679 = (this$["componentQueue"]);
if((temp__4429__auto___14679 == null)){
} else {
var cs_14680 = temp__4429__auto___14679;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue(cs_14680);
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__7057__auto__,writer__7058__auto__,opt__7059__auto__){
return cljs.core._write(writer__7058__auto__,"reagent.impl.batching/RenderQueue");
});
