...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7057__auto__,writer__7058__auto__,opt__7059__auto__){
return cljs.core._write(writer__7058__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14998 = o;
(G__14998[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6447__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6447__auto__){
var and__6447__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6447__auto____$1){
var and__6447__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__15006 = jsprops;
(G__15006["defaultValue"] = value);

(G__15006["onChange"] = ((function (G__15006,v,value,on_change){
return (function (p1__15004_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__15004_SHARP_);
});})(G__15006,v,value,on_change))
);
...
var vec__15011 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15011,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15011,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15011,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___15014 = reagent.impl.template.key_from_vec(v);
if((temp__4429__auto___15014 == null)){
} else {
var key_15015 = temp__4429__auto___15014;
(jsprops["key"] = key_15015);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__15017 = (new reagent.impl.template.NativeWrapper());
(G__15017["name"] = c);
...
var G__15019 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__15019) : reagent.impl.template.as_element.call(null,G__15019));
} else {
...
var len__7517__auto___15025 = arguments.length;
var i__7518__auto___15026 = (0);
while(true){
if((i__7518__auto___15026 < len__7517__auto___15025)){
args__7524__auto__.push((arguments[i__7518__auto___15026]));

var G__15027 = (i__7518__auto___15026 + (1));
i__7518__auto___15026 = G__15027;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7525__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15023){
var G__15024 = cljs.core.first(seq15023);
var seq15023__$1 = cljs.core.next(seq15023);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__15024,seq15023__$1);
});
...
break;
default:
var G__15031 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__15031;
continue;
...
var n__7362__auto___15032 = a.length;
var i_15033 = (0);
while(true){
if((i_15033 < n__7362__auto___15032)){
(a[i_15033] = reagent.impl.template.as_element((a[i_15033])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7362__auto___15035 = a.length;
var i_15036 = (0);
while(true){
if((i_15036 < n__7362__auto___15035)){
var val_15037 = (a[i_15036]);
if((cljs.core.vector_QMARK_(val_15037)) && ((reagent.impl.template.key_from_vec(val_15037) == null))){
(o["no-key"] = true);
} else {
}

(a[i_15036] = reagent.impl.template.as_element(val_15037));
...
var ctx = {};
var vec__15040 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15040,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15040,(1),null);
...
var G__15042 = (cljs.core.count(argv) - first_child);
switch (G__15042) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__15042){
